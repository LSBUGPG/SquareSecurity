...
public class BlockPersonGen : MonoBehaviour {
    ...
    public int theChosenSkin, theChosenHat, theChosenHair, theChosenGlasses, theChosenFacialHair, theChosenAccessory, theChosenShirt, theChosenHatColour, theChosenHairColour, theChosenGlassesColour, theChosenShirtColour, theChosenBodyColour;
    public bool hasHat, hasHair, hasGlasses, hasFacialHair, hasAccessory, hasShirt;
    ...
    void Awake() {
        ...
        // Spawn body
        var body =
            (GameObject)Instantiate(_blockPersonGameObject, meshPos.localPosition, new Quaternion(0, 0, 0, 0), meshPos);
        ...
        if (Random.Range(1, 100) > 10) {
			var hat = (GameObject)Instantiate(_hatsList[theChosenHat], hatPos.localPosition, new Quaternion(0, 0, 0, 0), hatPos);
		...
		foreach (var colourScript in GetComponentsInChildren<SetColour>()) {
			...
			colourScript.ChangeColour ("glasses", _glassesColourList [theChosenGlassesColour]); //Something is wrong! The code is breaking here!
